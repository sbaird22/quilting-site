...
const Header = () => {
    ...
    return (
        <header className="w-full bg-black font-papyrus text-teal-300 py-4 px-6 text-center border-b-4 border-black">
            <div className="flex items-center justify-between">
                    <img src={logo} alt="Your Grandfather's Quilt" className="h-16 mx-auto" />
                    <h1 className="text-3xl font-papyrus font-extrabold text-center flex-1">My Grandfather's Quilt</h1>
                ...
                >
                    ...
                    <ul className="font-bold flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-6 text-lg">
